...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-4">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrarPromocion.php">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Enlace de la Promocion: </label>
                        <input type="text" class="form-control" name="txtEnlace" autofocus required>
                    </div>
                    <div class="d-grid">
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-header">
                    Estructura de Opciones: <br>
                </div>
                <form class="p-4" method="POST" action="registrarPromocion.php">
                    <div class="mb-3">
                        <label class="form-label">Para enviar Mensaje: </label>
                        <br><a class="text-primary" ><i class="bi bi-cursor"></i></a>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Para enviar Enlace de Registro: </label>
                        <br><a class="text-danger" ><i class="bi bi-cursor"></i></a>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Para enviar Imagen Motivacional &#x1F44D;:</label>
                        <br><a class="text-warning" ><i class="bi bi-cursor"></i></a>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="text-danger" href="enviarEnlace.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-cursor"></i></a></td>
                                    <td><a class="text-warning" href="enviarImagen.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-cursor"></i></a></td>
                                    <td><a class="text-danger" href="eliminarPromocion.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-trash"></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
